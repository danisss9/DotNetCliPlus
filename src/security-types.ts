import type { DependencyKind } from './nuget-graph';
...
export interface ScanCoverage {
  component: 'inventory' | 'catalog' | 'scripts' | 'nuget-audit' | 'yara-x';
...
export const REVIEW_NOTICE = 'Static review of restored NuGet packages and their build scripts. Restore or build targets may already have executed. Pattern matches are indicators for investigation, not proof of malware. Compiled assemblies, runtime downloads, and code outside the scanned files are not covered.';
